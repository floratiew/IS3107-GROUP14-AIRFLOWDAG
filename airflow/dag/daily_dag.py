...
def my_dag():
    ...
    def run_mrt_clustering():
        ...
        # Running clustering
        df_mrt_cluster_id, df_mrt_cluster_stats = cluster_mrt_stations(df_mrt)
    ...
    bq_upload_task = BigQueryInsertJobOperator(
        ...
        configuration={
            "load": {
                ...
                "destinationTable": {
                    "projectId": "is3107-project-457501",
    ...
    ] >> extract_apis_task >> [run_school_clustering_task, run_mrt_clustering_task] >> join_clean_feature_engineering_task >> bq_upload_task
